    ...
    always_comb begin
        case (op)
            ...
            ALU_OP_X: begin
                ...
                // y[31:24] = ~|((b[31:24]) & `ALU_OP_X_MASK) ? a[b[25:24] << 3] : 8'b0;
                // y[23:16] = ~|((b[23:16]) & `ALU_OP_X_MASK) ? a[b[17:16] << 3] : 8'b0;
                // y[15:8] = ~|((b[15:8]) & `ALU_OP_X_MASK) ? a[b[9:8] << 3] : 8'b0;
                // y[7:0] = ~|((b[7:0]) & `ALU_OP_X_MASK) ? a[b[1:0] << 3] : 8'b0;
            end
            default: y = 0;
        endcase
    end
