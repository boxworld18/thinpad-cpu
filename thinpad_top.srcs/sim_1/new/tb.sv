...
module tb;
  ...
  parameter BASE_RAM_INIT_FILE = "/home/boxworld/Desktop/supervisor-rv/asmcode/time_irr.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路�??
  parameter EXT_RAM_INIT_FILE = "/tmp/kernel.elf";  // ExtRAM 初始化文件，请修改为实际的绝对路�??
...
//    $fclose(outputfile);
    ...
    #1000;
    uart.pc_send_byte(8'd108); // ASCII 'l'
    #1000;
    uart.pc_send_byte(8'd115); // ASCII 's'
    #1000000000;
    $finish;
